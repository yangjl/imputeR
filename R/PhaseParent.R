...
#'
#' Phasing haplotypes using parents' genotype data and kid array's genotype data.
#' Parents' genotype data can be confident genotyping data, for example, WGS data, or 
#' imputed genotype data generated by \code{impute_parent}.
#'
...
#' 
#' 
PhaseParent <- function(dad_geno, mom_array, progeny, ped, win_length=10, hom.error=0.02, het.error=0.8, 
