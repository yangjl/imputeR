...
This file is to document the R code we used to solve the problems step by step.
...
And $P(G'_{k}|G)$ is the probability of the $k$ th kid’s observed genotype given genotype $G$ by considering error rates and Mendelian segregation rate.
