...
# Crossing Scheme and the Experimental Design
...
We have obs. mom and obs. (selfed) kids.  We want to know $P(G|\theta)$, or the probability of the mom's genotype given observed data $\theta$. And according to [Bayes' theorem](https://en.wikipedia.org/wiki/Bayes%27_theorem), 
...
And $P(G'_{k}|G)$ is the probability of kid’s observed genotype given genotype $G$ by considering error rates and Mendelian segregation rate.
