...
$$P(G_m) = \prod\limits_{i=1}^{k1}(G'_{k1}|G_m)\times \prod\limits_{i=1}^{k2}\sum_{d}^{0,1,2}(G'_{k2}|G_m, G_d) \times P(G'_m|G_m)$$
...
$$P(H_m) = \prod\limits_{i=1}^{k1}(G'_{k1}|H_m)\times \prod\limits_{i=1}^{k2}(G'_{k2}|H_m, H_d)$$
...
$$P(H_k) =  \prod\limits_{s=1}^n{P(G'_{s}|H_m, H_d)}$$
