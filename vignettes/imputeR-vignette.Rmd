...
# Phasing focal parent's haplotypes using parents and progeny genotype data 
$P(H_1|\theta) \propto P(\theta|H_1) \times P(H_1)$   
$P(H_1|\theta) \propto \left( \prod\limits_{i=1}^{k}{P(G'_k|H_1, H_2)} \right) \times P(H_1) \times P(H_2)$  
$P(H_1|\theta) \propto \left( \prod\limits_{i=1}^{k}\prod\limits_{l=1}^{n}{P(G'_{i,l}|H_1, H_2)} \right) \times P(H_1) \times P(H_2)$
